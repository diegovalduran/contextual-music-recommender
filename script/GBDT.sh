...
echo "Starting Setting2 experiments (lr=0.1, n_estimators=200, max_depth=5)..."
...
for seed in {101..110}; do
  for context_group in CONTEXT_all CONTEXT_sub CONTEXT_obj; do
    ...
    output=$(python main.py --model_name GBDT --datadir ${DATADIR} \
      --save_anno setting2_${context_group}_${seed} \
      --dataname setting2-${seed} \
...
echo -e "\nStarting Setting3 experiments (lr=0.05, n_estimators=100, max_depth=5)..."
...
for seed in {101..110}; do
  for context_group in CONTEXT_all CONTEXT_sub CONTEXT_obj; do
    ...
    output=$(python main.py --model_name GBDT --datadir ${DATADIR} \
      --save_anno setting3_${context_group}_${seed} \
      --dataname setting3-${seed} \
      --context_column_group ${context_group} \
      --random_seed ${seed} \
      --lr 0.05 \
      --n_estimators 100 \
