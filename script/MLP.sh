...
echo "Starting Setting2 experiments (learning_rate=5e-3, batch_size=256)..."
...
for seed in {101..110}; do
  for context_group in CONTEXT_all CONTEXT_sub CONTEXT_obj; do
    ...
    output=$(python main.py --model_name MLP --datadir ${DATADIR} \
...
echo -e "\nStarting Setting3 experiments (learning_rate=1e-3, batch_size=512)..."
