...
echo "Starting Setting2 experiments (max_depth=3, n_estimators=300)..."
...
for seed in {101..110}; do
  for context_group in CONTEXT_all CONTEXT_sub CONTEXT_obj; do
    ...
    output=$(python main.py --model_name RF --datadir ${DATADIR} \
...
echo -e "\nStarting Setting3 experiments (max_depth=5, n_estimators=200)..."
